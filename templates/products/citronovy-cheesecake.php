    ...
    <div class="section">
        ...
        <div class="post">
            <div class="post__intro">
                <h1>Citronový cheesecake</h1>

                <div class="post__fig">
                    <img src="images/products/citronovy-cheesecake-1.jpg" alt="" width="400" />	
                </div>					
                ...
                <p>Sametový, lehký a osvěžující dort. Nádherná kombinace kakaa a citrónu.</p>
            </div><!-- /post__intro -->
            ...
            <div class="post__row post__row--primary">
                <div class="post__article">
                    ...
                    <ul>
                        <li>kakaové celozrnné sušenky</li>
                        <li>máslo</li>
                        <li>čerstvý sýr</li>
                        <li>smetana</li>
        ...
        <div class="cta">
            <a href="napiste-nam?p=citronovy-cheesecake" class="btn btn--wide">OBJEDNAT</a>
        </div>
