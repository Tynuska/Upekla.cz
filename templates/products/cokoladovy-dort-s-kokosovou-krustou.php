			...
			<div class="section">
				...
				<div class="post">
					<div class="post__intro">
						<h1>Čokoládový dost<br />s kokosovou krustou</h1>

						<div class="post__fig">
							<img src="images/products/cokoladovy-dort-s-kokosovou-krustou-1.jpg" alt="" width="400" />	
						</div>					
<div class="post__meta">
						...
						<p>Křehký kokosový korpus a hutná čokoládová náplň z hořké čokolády s kapkou pálenky. Vhodný pro bezlepkovou dietu.</p>
					</div><!-- /post__intro -->
				...
				<div class="cta">
					<a href="napiste-nam?p=cokoladovy-dort-s-kokosovou-krustou" class="btn btn--wide">OBJEDNAT</a>
				</div>
