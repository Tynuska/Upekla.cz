			...
			<div class="section">
				...
				<div class="post">
					<div class="post__intro">
						<h1>Kokosový dort s čokoládou</h1>

						<div class="post__fig">
							<img src="images/products/kokosovy-dort-1.jpg" alt="" width="400" />	
						</div>					
						...
						<p>Božský šťavnatý dort s bílou a hořkou čokoládou, plný kokosu, smetany a s kapkou rumu.</p>
					</div><!-- /post__intro -->
					...
					<div class="post__row post__row--primary">
						...
						<div class="post__fig">
							<img src="images/products/kokosovy-dort-2.jpg" alt="" width="400" />
						</div>	
					</div>
				...
				<div class="cta">
					<a href="napiste-nam?p=kokosovy-dort" class="btn btn--wide">OBJEDNAT</a>
				</div>
