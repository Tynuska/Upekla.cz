			...
			<div class="section">
				...
				<div class="post">
					<div class="post__intro">
						...
						<div class="post__fig">
							<img src="images/products/mandlovy-dort-1.jpg" alt="" width="400" />	
						</div>					
						...
						<p>Vrstvy sněhových plátů plných mletých mandlí s jemným žloutkovým krémem. Prosypané nasekanými mandlemi. Bez mouky. Bez laktózy.</p>
					</div><!-- /post__intro -->
					...
					<div class="post__row post__row--primary">
						...
						<div class="post__fig">
							<img src="images/products/mandlovy-dort-2.jpg" alt="" width="400" />
						</div>	
					</div>
				...
				<div class="cta">
					<a href="napiste-nam?p=mandlovy-dort" class="btn btn--wide">OBJEDNAT</a>
				</div>
