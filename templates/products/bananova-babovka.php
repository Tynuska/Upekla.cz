			...
			<div class="section">
				...
				<div class="post">
					<div class="post__intro">
						<h1>Banánová bábovka</h1>

						<div class="post__fig">
							<img src="images/products/bananova-babovka-1.jpg" alt="" width="400" />	
						</div>		
						...
						<p>Vláčná, šťavnatá a voňavá bábovka plná banánů.</p>
					</div><!-- /post__intro -->
					...
					<div class="post__row post__row--primary">
						...
						<div class="post__fig">
							<img src="images/products/bananova-babovka-2.jpg" alt="" width="400" />
						</div>	
					</div>
				...
				<div class="cta">
					<a href="napiste-nam?p=bananova-babovka" class="btn btn--wide">OBJEDNAT</a>
				</div>
